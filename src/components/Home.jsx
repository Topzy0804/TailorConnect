            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed font-light">
                  The heritage of TailorConnect is built on a foundation of professional craftsmanship and a deep-rooted passion for luxury fashion. Rather than just being a digital marketplace, the platform serves as a bridge between traditional tailoring techniques and modern design aesthetics.
                </p>
